...
namespace svg {
  ...
  void
  SVGPolygonElement::glTraverse(svgl::Context * svglContext, svgl::GLInfo* glinfo)
  {
  ...
  void
  SVGPolygonElement::pickTraverse(svgl::Context * svglContext, svgl::GLInfo* glinfo)
  {
    const SVGPointList& pl = GET_SIMPLE_VAL(Points);
    if (pl.numberOfItems()<2)
      return;
  ...
  void
  SVGPolygonElement::glTraverseBoundingBox(svgl::Context * svglContext, svgl::GLInfo* glinfo)
  {
    const SVGPointList& pl = GET_SIMPLE_VAL(Points);
    if (pl.numberOfItems()<2)
      return;
  ...
  void
  SVGPolygonElement::getBoundingBox(svgl::Context* svglContext, svgl::GLInfo* glinfo, float* bbx, float* bby, float* bbwidth, float* bbheight)
  {
  ...
  void
  SVGPolygonElement::asBezier(svgl::Context * svglContext, svgl::GLInfo* glinfo, BezierPath* bezier)
  {
    const SVGPointList& pl = GET_SIMPLE_VAL(Points);
	...
	void
	SVGPolygonElement::asBezier(svgl::Context* svglContext, svgl::GLInfo* glinfo, agg::path_storage* ppath)
  {
		const SVGPointList& pl = GET_SIMPLE_VAL(Points);
