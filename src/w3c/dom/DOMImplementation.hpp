#ifndef _dom_DOMImplementation_hpp_
#define _dom_DOMImplementation_hpp_
/*
...
public:
     ...
     */
    virtual bool hasFeature(String * feature, 
     ...
     * @since DOM Level 2
     */
    virtual DocumentType * createDocumentType(String * qualifiedName, 
					      String * publicId, 
					      String * systemId)
                                            throw(DOMException);
  ...
  virtual DocumentType * createDocumentType(String * qualifiedName)
     ...
     * @since DOM Level 2
     */
    virtual Document * createDocument(String * namespaceURI, 
    ...
    virtual void		registerPrototype(Document * proto);
protected:
    static DOMImplementation * singleton;
    static void			setDOMImplementation(DOMImplementation * impl);
#if SVGL_USE_GC
    typedef std::vector<Document*,gc_alloc<Document*> >	ProtoList;
#else
    typedef std::vector<Document*>	ProtoList;
#endif
