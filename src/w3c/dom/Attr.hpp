#ifndef _dom_Attr_hpp_
#define _dom_Attr_hpp_
/*
...
public:
	...
	throw (DOMException);
    virtual void		setNodeValue(String * value)
	throw(DOMException);
    ...
    virtual Node *		insertBefore(Node * newChild,
					     Node * refChild)
	throw(DOMException);
    virtual Node *		internalInsertBefore(Node * newChild,
						     Node * refChild)
	throw(DOMException);
    ...
    virtual void		setOwnerElement(Element * doc);
    virtual void		removeIdRef() const;
    virtual void		addIdRef() const;
protected:
