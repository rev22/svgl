#ifndef _dom_DocumentType_hpp_
#define _dom_DocumentType_hpp_
/*
 ...
 */
class DocumentType : public ParentNode {
public:
     ...
     * @since DOM Level 2
     */
    virtual String * getInternalSubset() const;
    ...
    virtual NamedNodeMap * getElements() const;
