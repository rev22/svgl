#ifndef _dom_CDATASection_hpp_
#define _dom_CDATASection_hpp_
/*
 ...
 * the delimiters.
 * <p>The <code>String</code> attribute of the <code>Text</code> node holds 
...
public:
  			CDATASection(Document * ownerDoc, String * data);
