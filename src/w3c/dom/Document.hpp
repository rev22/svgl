#ifndef _dom_Document_hpp_
#define _dom_Document_hpp_
/*
...
public:
     ...
     *   illegal character.
     */
    virtual Element * createElement(String * tagName)
                                  throw(DOMException);
     ...
     */
    virtual Text * createTextNode(String * data);
     ...
     */
    virtual Comment * createComment(String * data);
     ...
     */
    virtual CDATASection * createCDATASection(String * data)
                                            throw(DOMException);
     ...
     */
    virtual ProcessingInstruction * createProcessingInstruction(String * target, 
                                                             String * data)
                                                              throw(DOMException);
     ...
     *   illegal character.
     */
    virtual Attr * createAttribute(String * name)
                                 throw(DOMException);
     ...
     *   <br>NOT_SUPPORTED_ERR: Raised if this document is an HTML document.
     */
    virtual EntityReference * createEntityReference(String * name)
                                                  throw(DOMException);
     ...
     *   <code>Elements</code>.
     */
    virtual NodeList * getElementsByTagName(String * tagname) const;
     ...
     * @since DOM Level 2
     */
    virtual Element * createElementNS(String * namespaceURI, 
     ...
     * @since DOM Level 2
     */
    virtual Attr * createAttributeNS(String * namespaceURI, 
                                  String * qualifiedName)
                                   throw(DOMException);
     ...
     * @since DOM Level 2
     */
    virtual Element *	getElementById(String * elementId) const;
	...
	throw(DOMException);
#if SVGL_USE_GC
    typedef std::map<String*,Element*, string_less, ::gc_alloc<std::pair<const String*, Element*> > >
    			Ids;
#else
    typedef std::map<String*,Element*, string_less >
    			Ids;
#endif
    virtual void	putIdentifier(String * idName, Element * element);
    virtual Element *	getIdentifier(String * idName) const;
    virtual void	removeIdentifier(String * idName);
    Ids::const_iterator	id_begin() const { return identifiers.begin(); }
    Ids::const_iterator	id_end() const { return identifiers.end(); }
    virtual void	putIdentifiers(const Node * root);
    virtual void	removeIdentifiers(const Node * root);
    virtual void	rebuildIdentifiers();

    virtual void	replacedText(Node * node);
    virtual void	deletedText(Node * node,
				    unsigned int offset,
				    unsigned int count);
    virtual void	insertedText(Node * node,
				     unsigned int offset,
				     unsigned int count);
    virtual void	splitData(Node * node,
				  Node * newNode,
				  unsigned int offset);
    virtual void	removedChildNode(Node * oldChild);

    virtual void	changed();
    virtual int		changes() const;
    virtual AttributeMap * createAttributeMap(Element * e,
