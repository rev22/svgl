#ifndef _dom_CharacterData_hpp_
#define _dom_CharacterData_hpp_
/*
 ...
 * <p>As explained in the <code>String</code> interface, text strings in 
 * the DOM are represented in UTF-16, i.e. as a sequence of 16-bit units. In 
 * the following, the term 16-bit units is used whenever necessary to 
 * indicate that indexing on CharacterData is done in 16-bit units.
 * <p>See also the <a href='http://www.w3.org/TR/2000/REC-DOM-Level-2-Core-20001113'>Document Object Model (DOM) Level 2 Core Specification</a>.
 */
class CharacterData : public ChildNode {
public:
    /**
     ...
     * not fit into a single <code>String</code>. In such cases, the user 
     ...
     */
    virtual String * substringData(unsigned int offset, 
				   unsigned int count)
                                 throw(DOMException);
     ...
     * @param argThe <code>String</code> to append.
     * @exception DOMException
     ...
     * @param argThe <code>String</code> to insert.
     * @exception DOMException
     *   INDEX_SIZE_ERR: Raised if the specified <code>offset</code> is 
     *   negative or greater than the number of 16-bit units in 
     *   <code>data</code>.
     ...
     */
    virtual void insertData(unsigned int offset, 
			    String * arg)
                            throw(DOMException);
     ...
     *    method invocation).
     * @param argThe <code>String</code> with which the range must be 
     *   replaced.
     * @exception DOMException
     *   INDEX_SIZE_ERR: Raised if the specified <code>offset</code> is 
     *   negative or greater than the number of 16-bit units in 
    ...
    virtual String *	getNodeValue() const throw (DOMException);
    virtual void	setNodeValue(String * value) throw (DOMException);
protected:
  			CharacterData(Document * ownerDocument,
				      String * data);
